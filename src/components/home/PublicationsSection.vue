              ...
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="mb-1">
                    ...
                    <h4 class="font-semibold text-gray-800 text-base leading-tight group-hover:text-purple-700 transition-colors duration-200" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
